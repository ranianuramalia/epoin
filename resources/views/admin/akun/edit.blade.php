...
<body>
    ...
    <form  action="{{ route('akun.update',$akun->id ) }}" method="POTS" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <h2>Data Akun</h2>
    ...
    <form  action="{{ route('updateEmail',$akun->id ) }}" method="POTS" enctype="multipart/form-data">
        @csrf
        @method('PUT')
    
        <label>email eddres</label><br>
    ...
    <form  action="{{ route('updatePassword',$akun->id ) }}" method="POTS" enctype="multipart/form-data">
        @csrf
        @method('PUT')
